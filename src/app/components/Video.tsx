import { videoData } from '@/app/components/MultipleBlock';
...
/>
          ...
          <div className="flex flex-col w-[272px] items-start gap-2.5 relative flex-[0_0_auto]">
            ...
            <div className="flex flex-col items-start gap-[15px] relative self-stretch w-full flex-[0_0_auto]">
              <p className="relative self-stretch mt-[-1.00px] [font-family:'Miller_Display-Roman',Helvetica] font-normal text-black text-xl tracking-[0] leading-[26px] font-size-samll">
